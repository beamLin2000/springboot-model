...
public interface RefundMapper extends BaseMapper<RefundListDto> {
    ...
    void updateRefundStatusByApplicationNo(@Param("applicationNo") String applicationNo,@Param("refundMark") String refundMark,@Param("refundStatus") String refundStatus,@Param("orderStatus") String orderStatus,@Param("date") Date date);
}
